  ...
  return (
    <div className="flex items-center justify-center w-full h-full mt-4 mb-1 border-t-2 border-b-2">
        ...
        <img
          ...
          src={
            selectedCategory === categories[0]?._id
              ...
              : "https://theme.hstatic.net/1000365849/1000614631/14/baloden.svg?v=144"
          }
          alt=""
          height={60}
          width={60}
        ...
        <img
          src={
            selectedCategory === categories[2]?._id
              ? "https://theme.hstatic.net/1000365849/1000614631/14/tuixachdo.svg?v=178"
              : "https://theme.hstatic.net/1000365849/1000614631/14/tuixachden.svg?v=144"
          }
          alt=""
          width={79}
          height={60}
      ...
      <div className="flex px-10">
        <img
          src={
            selectedCategory === categories[3]?._id
